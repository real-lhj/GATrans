...
from transformer_encoder_decoder import TransEncDec, TransEncDec_withoutProjection
import pandas as pd
import os
...
if __name__ == '__main__':
    id = datetime.now().strftime("%Y%m%d_%S%M%H")
    print(id)
    # 1. args
    ...
    n_features = 38
    dropout = 0.01
    model_name = "transformer_SMD_3-1_project.pt"  # 保存模型的名字
    # training args:
    # output_path = 'output/SMD/{group}'
    log_dir = f'output/SMD/{group}/logs'
